...
### 3. 文章审核
对文章进行AI相关性判断和深度评估，过滤非AI相关内容并评估文章专业程度。
...
返回结果包含：
- `is_ai_related`: 是否与AI相关
- `ai_directness`: 相关度（direct/indirect/unrelated）
- `depth_level`: 深度等级（surface/technical/research）
- `key_points`: 核心要点
- `keywords`: 关键词
